...
class LootsControllerTest < ActionController::TestCase
  ...
  test "should create loot" do
    assert_difference('Loot.count') do
      post :create, loot: { experimental: @loot.experimental, external_link: @loot.external_link, name: @loot.name, stackable: @loot.stackable, type: @loot.type }
    end
  ...
  test "should update loot" do
    patch :update, id: @loot, loot: { experimental: @loot.experimental, external_link: @loot.external_link, name: @loot.name, stackable: @loot.stackable, type: @loot.type }
    assert_redirected_to loot_path(assigns(:loot))
  end
